...
\emph{negation as failure:}\fixme{jeremy}{is negation-as-failure = closed-world assumption?} to deduce $\neg \atom{reachable}{X}$ it suffices to
...
and QSQR\fixme{jeremy}{citations and brief explanations for magic sets, tabling,
  QSQR} exist to address this problem, in static analysis this eager approach is
sensible: we generally wish to analyse the whole program exhaustively, whether
for optimization or for bug-finding purposes. \todolater{this is not entirely
  convincing.}
...
monotone\fixme{achim}{explain}, and thus the ascending chain condition provides
