...
%
  ...
  \todo{ok, but how about monotonicity. relate to transition function?}
...
For example: \todo{use single-source reachability here?}
...

\section{Case study: Datalog for static analysis}
...
%
But probably Datalog's most significant real-world adoption has been as a tool for scalable static analysis~\todo{cite: bddbddb, doop, Semmle, souffle}.
...
\todo{explain what each one used it for:}
...
\item Guided by this type system and its semantics, we can add practical
  features to our language, such as semilattices, aggregation, arithmetic, and
  compound datatypes, without sacrificing its guarantees.
