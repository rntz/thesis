\begin{figure}
  \begin{mathpar}
    ...
    \begin{array}{rcl}
      \stripcx{\emptycx} & = & \emptycx\\
      \stripcx{\G,\, \hm x A} & = & \stripcx\G\\
      \stripcx{\G,\, \hd x A} & = & \stripcx\G,\, \hd x A
    \end{array}
    \\
    \infer[\rn{var}]{\hm x A \in \G}{\J {\mvar x} \G A}
    ...
    \infer[\rn{bot}]{\quad}{\J\bot\G {L}}

    \infer[\rn{join}]{(\J{e_i} \G {L})_i}{\J{e_1 \vee e_2}\G {L}}
