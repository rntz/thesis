...
static analysis, business analytics, and distributed
programming~\todo{citation}. Datalog is high-level and declarative, but simple
and well-studied enough to admit efficient implementation strategies. For
example, \citeauthor{DBLP:conf/aplas/WhaleyACL05} found they could replace a
hand-tuned C implementation of context-sensitive pointer analysis with a
...
\item In the process of generalizing seminaive evaluation, we uncover \todo{a
  theory of monotone change for higher-order languages.}
\end{enumerate}
