\begin{figure}
  \centering\small\sffamily%\footnotesize
...
\begin{figure}
  ...
  \todo{finish graphs for bottom insertion vs just propagation}
  ...
  \begin{tikzpicture}[baseline=(current bounding box.center)]
    \begin{semilogyaxis}[
        ...
        height=132.88pt, width=213pt, % golden
        %height=140pt, width=210pt, % 2:3
        legend entries={simplified,optimized},
        legend cell align=left,
        legend pos = north west,
        legend style={
          font=\footnotesize,
      ...
      \addplot [color=purple,mark=o] table [x=n,y=seminaive_simple] {trans.dat};
      \addplot [color=blue,mark=*] table  [x=n,y=seminaive] {trans.dat};
    \end{semilogyaxis}
  \end{tikzpicture}
