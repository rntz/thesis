...
\item We express fixed points as a binding form, $\efixis x e$, instead of explicitly supplying a boxed lambda to the \prim{fix} combinator, $\efix\ebox{\efn x e}$.
...
\todo{remark on similarity of this to performing magic sets on previous combinator?}
