...
%
It begins with fairly standard parsing and typechecking phases. For parsing, we use OCaml's Menhir library.\footnote{\url{http://gallium.inria.fr/~fpottier/menhir/}} The typechecker is bidirectional~\citep{bidirectional} rather than performing Hindley-Milner inference\todo{citation}, for simplicity of implementation.
%
