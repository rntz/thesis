...
\todo{expand and edit this section}
...
\item Finding the transitive closure of a linear graph using the \name{trans}
  function from \cref{section-generic-transitive-closure}. We chose this example
  because, as discussed in \cref{section-seminaive-and-ilc}, it has a well
...
However, as demonstrated in \cref{section-seminaive-examples}, if the body can be
