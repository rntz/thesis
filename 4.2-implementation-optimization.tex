...
%
\todo{forward reference where we discuss these details.}
...
%
We exhibit the four translations of \name{trans} in \cref{figure-trans-naive,figure-trans-seminaive-raw,figure-trans-seminaive-simple,figure-trans-seminaive}.
%
...
\item The $\phi$ transformation combined with optimizations enables asymptotic
  ...
  \todo{use a log plot of speedups}.
%
...
\todo{Rewrite remainder of section. Discuss: four compiler paths; naive vs seminaive; why bottom insertion seems to do nothing.}
