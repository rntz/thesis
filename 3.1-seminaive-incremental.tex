...
\todo{rewrite/edit from this point on}
...
Now let's move from Datalog to Datafun.\footnote{In this section we do not
  ...
  muddies our examples to no benefit.} The transitive closure of \name{edge} is
...
%%   \end{gathered}
%%   &%\quad\implies\quad
%%   \mathrel{\begin{gathered}
%%     \implies\\\vphantom{\Updownarrow}\\\implies
%%   \end{gathered}}
%%   \begin{gathered}
%%     \changesat{\tseteq A}{\name{step}'\<\dx}{\name{step}\<x}{\name{step}\<y}
%%     \\
