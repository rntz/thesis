...
with a centered dot, so $f \then g : A \to C$ means $f : A \to B$ followed by $g
: B \to C$.
%
\fixme{jeremy}{don't use center dot for forwards composition; use reverse compositions or else use semicolon.}
%
