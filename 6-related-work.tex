...
associates.\fixme{jeremy}{This requires more than commutativity in associativity, as you'll discover if you try to do the same trick for maximum.} This is what allows us to combine a sum $\sum_i x_i$ with a
...
change $\gvalid{A \to B}{df}{f_1}{f_2}$ is one which takes \fixme{achim}{This doesn't mention the first argument of type A.} valid input changes
...
%
\footnotemark
\footnotetext{In the original presentation by \citet{incremental} these operators
